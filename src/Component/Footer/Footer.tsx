            ...
            <div className="container mx-auto px-4 md:px-6 max-w-6xl">
                            ...
                            <ul className="space-y-1 md:space-y-2">
                                <li>
                                    <button
                                        ...
                                        className="text-xs md:text-sm hover:text-[#BBFBFF] transition-colors opacity-80 hover:opacity-100 bg-transparent border-none cursor-pointer"
                                    >
                                        My Lists
                                    </button>
                                </li>
                ...
                <div className="border-t border-white/20 mt-6 pt-4 text-center">
                    <p className="text-xs opacity-75">
                        &copy; {new Date().getFullYear()} Mbuso. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
